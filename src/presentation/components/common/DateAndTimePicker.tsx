...
const DateAndTimePicker: React.FC<DateAndTimePickerProps> = ({
  ...
  const renderTimePicker = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-3 px-2 bg-gray-50 dark:bg-gray-800/50 min-h-[140px]">
        <label className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-3">
          Select Time
        </label>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <select
              ...
              className="w-16 px-2 py-1 text-sm font-mono border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 outline-none appearance-none cursor-pointer"
            >
